...
email="maslov.rostislav@gmail.com" # Adding a valid address is strongly recommended
...
case "$email" in
  "") email_arg="--email maslov.rostislav@gmail.com" ;;
...
# Директорию менять нельзя
chmod 777 -R /opt/docker/docker-volumes/certbot;