...
public class TaskMapper implements ExampleDataMapper<TaskEntity, TaskDoc> {
    ...
    public TaskDoc map(TaskEntity entity) {
        return TaskDoc
                ...
                .suggestForViewIds(ObjectIdHelper.mapOrDie(entity.getSuggestForViewIds()))
                ...
                .deadlineChangeFewTimes(entity.getDeadlineChangeFewTimes())
    ...
    public TaskEntity inverseMap(TaskDoc doc) {
        return TaskEntity
                ...
                .suggestForViewIds(doc.getSuggestForViewIds().stream().map(id -> id.toString()).collect(Collectors.toSet()))
                .deadline(doc.getDeadline())
                .deadlineType(doc.getDeadlineType())
                .timezone(doc.getTimezone())
                .deadlineChangeFewTimes(doc.getDeadlineChangeFewTimes())
