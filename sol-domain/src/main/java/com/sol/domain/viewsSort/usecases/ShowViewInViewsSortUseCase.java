...
public class ShowViewInViewsSortUseCase extends UseCase<ShowViewInViewsSortUseCase.InputValues, SingletonEntityOutputValues<ViewsSortEntity>> {
    ...
    public SingletonEntityOutputValues<ViewsSortEntity> execute(InputValues inputValues) {
        ...
        viewsSortEntity.getViewsId().add(inputValues.viewId);
