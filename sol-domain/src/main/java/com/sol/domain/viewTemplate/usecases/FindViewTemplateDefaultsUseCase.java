...
public class FindViewTemplateDefaultsUseCase extends UseCase<FindViewTemplateDefaultsUseCase.InputValues, SearchResultEntityOutputValues<ViewTemplateEntity>> {
    ...
    public static class InputValues implements UseCase.InputValues {
        protected ViewTemplateDefaultsFilters filters;
    }
}
