...
public class DeleteParamsToViewInTemplateUseCase extends UseCase<DeleteParamsToViewInTemplateUseCase.InputValues, SingletonEntityOutputValues<ViewTemplateEntity>> {
    ...
    public SingletonEntityOutputValues<ViewTemplateEntity> execute(InputValues inputValues) {
        ...
        viewTemplateEntity.getView().getParams().removeAll(toDelete);
