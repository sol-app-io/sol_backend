...
public class FindViewTemplatesUseCase extends UseCase<FindViewTemplatesUseCase.InputValues, SearchResultEntityOutputValues<ViewTemplateEntity>> {
    ...
    public static class InputValues implements UseCase.InputValues {
        protected ViewTemplateFilters filters;
    }
}
